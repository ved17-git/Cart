...
const token=localStorage.getItem('token')
  ...
  <motion.div   
   ...
   transition={{duration:1.3}}> 
    ...
    <div className="text-center mx-auto space-y-8 relative top-[18vh] md:top-[4vh] md:space-y-10 md:py-12" >
  
   <div className="text-xl bg-[#F0FFD4] w-fit mx-auto rounded-lg px-12 py-4 md:px-[2vh] md:text-[2vh] md:font-semibold"> 
   Trusted by Thousands Every Month  </div>
 


    <h1 className="text-5xl font-bold md:px-[1vh]">Instant Product Lookup with Barcode Entry</h1> 
